...
* Primer sistema de almacenamiento de infromación **binaria**.
* El telar usaba un sistema de **tarjetas perforadas** para lograr diseños  o dibujos complejos.
...
* Introdujo 3 conceptos fundamentales en la computación moderna:
...
Matemática y escritora británica, conocida por su trabajo pionero en el campo de la programación  y su colaboración con Charles Babbage en la invención de la Máquina Analítica. 
...
* No es una máquina física, es un **experimento mental** (máquina teórica). Imaginó una cinta infinita, un cabezal que lee/escribe símbolos, y un conjunto de reglas.}
...
El Software Libre bsuca garantizar 4 libertades escenciales: 

1. **Libertad 0 (uso):** Ejecutar el programa como se desee, con cualquier propósito.
2. **Libertad 1 (Estudio):** Estudiar como funciona el programa y cambiarlo para que haga lo que el usuario quiera.
3. **Libertad 2 (Distribuición):** Redistribuir copias para ayudar a otros.
4. **Libertad 3 (Mejora):** Mejorar el programa y hacer públicas las mejoras, para beneficiar a otros.

Principios fundamentales adicionales de la FSF:

1. Libertad, no precio.
2. Copyleft.
